  ...
  export namespace contracts {
    export namespace governance {
      export class proposal_record {
        static encode(message: proposal_record, writer: Writer): void {
          ...
          if (proposal !== null) {
            writer.uint32(10);
            writer.fork();
            koinos.protocol.transaction.encode(proposal, writer);
            writer.ldelim();
          }
        ...
        static decode(reader: Reader, length: i32): proposal_record {
          ...
          while (reader.ptr < end) {
            ...
            switch (tag >>> 3) {
              case 1:
                message.proposal = koinos.protocol.transaction.decode(
                  reader,
                  reader.uint32()
                );
                break;
        ...
        proposal: koinos.protocol.transaction | null;
        vote_start_height: u64;
        vote_tally: u64;
        vote_threshold: u64;
        shall_authorize: bool;
        updates_governance: bool;
        status: koinos.contracts.governance.proposal_status;

        constructor(
          proposal: koinos.protocol.transaction | null = null,
          vote_start_height: u64 = 0,
          vote_tally: u64 = 0,
          vote_threshold: u64 = 0,
          shall_authorize: bool = false,
          updates_governance: bool = false,
          status: koinos.contracts.governance.proposal_status = 0
        ) {
      ...
      export class get_proposal_by_id_result {
        static encode(
          ...
          if (value !== null) {
            writer.uint32(10);
            writer.fork();
            koinos.contracts.governance.proposal_record.encode(value, writer);
            writer.ldelim();
          }
        }
        ...
        static decode(reader: Reader, length: i32): get_proposal_by_id_result {
          ...
          while (reader.ptr < end) {
            ...
            switch (tag >>> 3) {
              case 1:
                message.value =
                  koinos.contracts.governance.proposal_record.decode(
                    reader,
                    reader.uint32()
                  );
                break;
        ...
        value: koinos.contracts.governance.proposal_record | null;

        constructor(
          value: koinos.contracts.governance.proposal_record | null = null
        ) {
          this.value = value;
        }
      }
      ...
      export class get_proposals_by_status_result {
        static encode(
          ...
          for (let i = 0; i < value.length; ++i) {
            writer.uint32(10);
            writer.fork();
            koinos.contracts.governance.proposal_record.encode(
              value[i],
              writer
            );
            writer.ldelim();
        ...
        value: Array<koinos.contracts.governance.proposal_record>;
      ...
      export class proposal_submission_event {
        ...
        proposal: koinos.contracts.governance.proposal_record | null;

        constructor(
          proposal: koinos.contracts.governance.proposal_record | null = null
        ) {
          this.proposal = proposal;
        }
      }
